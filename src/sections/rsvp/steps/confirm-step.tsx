...
export function ConfirmStep({ form, onEdit }: Props) {
  ...
  if (!attending) {
    return (
      <div className="rounded-soft border border-border-subtle bg-surface-muted p-6 text-center dark:bg-surface/30">
  ...
  return (
    <div className="space-y-3 rounded-soft border border-border-subtle bg-surface-muted p-6 dark:bg-surface/30">

...
export function RsvpSuccess({ attending, onEdit }: Props) {
  ...
  return (
    <div className="rounded-soft border border-muted-gold/30 bg-muted-gold/5 p-8 text-center">
      ...
      <button
        type="button"
        onClick={onEdit}
        className="mt-6 text-xs uppercase tracking-[0.3em] text-muted-gold underline-offset-4 hover:underline"
      >

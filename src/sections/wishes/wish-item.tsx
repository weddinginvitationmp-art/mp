  ...
  return (
    <li className="border-b border-border-subtle py-4 last:border-0">
      <p className="flex items-baseline gap-3 text-sm">
        <span className="font-display text-base text-slate-500">{wish.guestName}</span>
      ...
      {isLong && (
        <button
          ...
          className="mt-1 text-[11px] uppercase tracking-widest text-slate-500 hover:opacity-80 touch-action-manipulation"
        >
